...
<head>
    ...
    <meta charset="utf-8">
    <title>Book :: Ticket Online&trade;</title>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="https://i.imgur.com/TNznbKa.png">
      ...
      <div class="container">
        ...
        <div class="row justify-content-center">
          <div class="col-lg-8 col-xl-7 mt-4">
            <img src="https://i.imgur.com/eK8jlP5.jpg" alt="Image" class="shadow-lg">
          </div>
        </div>
